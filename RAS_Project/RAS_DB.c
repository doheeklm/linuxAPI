...
int DB_InitPreparedStatement( DB_t *ptDB )
{
	...
	DB_INIT_PSTMT( ptDB, PSTMT_SELECT_CLI_IP_ALL, SQL_SELECT_CLI_IP_ALL );
	DB_INIT_PSTMT( ptDB, PSTMT_SELECT_CLI_IP_BY_IP, SQL_SELECT_CLI_IP_BY_IP );
	DB_INIT_PSTMT( ptDB, PSTMT_DELETE_CLI_IP, SQL_DELETE_CLI_IP );

	DB_INIT_PSTMT( ptDB, PSTMT_INSERT_USR_INFO, SQL_INSERT_USR_INFO );
	DB_INIT_PSTMT( ptDB, PSTMT_SELECT_USR_INFO_ALL, SQL_SELECT_USR_INFO_ALL );
	DB_INIT_PSTMT( ptDB, PSTMT_SELECT_USR_INFO_BY_ID, SQL_SELECT_USR_INFO_BY_ID );
...
int DB_CheckClientIp( DB_t tDB, char *pszIp )
{
	...
	DB_PREPARED_EXEC( tDB, tDB.patPstmt[PSTMT_SELECT_CLI_IP_BY_IP], &ptRes, nRC );
